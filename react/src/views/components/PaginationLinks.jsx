      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{meta.from}</span> to <span className="font-medium">{meta.to}</span> of { meta.total} results
          </p>
        </div>
        <div>
            ...
            {meta.links && meta.links.map((link, ind) => (
              <a
                ...
                className={'relative z-10 inline-flex items-center  px-4 py-2 text-sm font-semibold '
                  ...
                  +(link.active ? ' bg-indigo-600 focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-white' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0')}
              >
              </a>
            ))}
